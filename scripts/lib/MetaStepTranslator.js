          ...
          tooltip: {
            ...
            description: metaStep.description || {
              messageByLocale: {
                ...
                fi: 'Olemme valmiita! Testataan peliämme nähdäksemme tekemämme muutokset! Klikkaa **Esikatselu**-painiketta.',
      ...
      return [
          ...
          tooltip: {
            description: {
              messageByLocale: {
                ...
                fi: 'Katso **objektin käyttäytymiset** täältä.',
        ...
        },
        {
          ...
          tooltip: {
            description: {
              messageByLocale: {
                en: `Let's add the **${metaStep.behaviorDisplayNameByLocale['en']}** behavior.`,
                fr: `Ajoutons le comportement **${metaStep.behaviorDisplayNameByLocale['fr']}**.`,
                ar: `هيّا نقوم بإضافة السلوك **${metaStep.behaviorDisplayNameByLocale['ar']}**.`,
                de: `Fügen wir das **${metaStep.behaviorDisplayNameByLocale['de']}**-Verhalten hinzu.`,
                es: `Agreguemos el comportamiento **${metaStep.behaviorDisplayNameByLocale['es']}**.`,
                fi: `Lisätään **${metaStep.behaviorDisplayNameByLocale['fi']}**-käyttäytyminen.`,
                it: `Aggiungiamo il comportamento **${metaStep.behaviorDisplayNameByLocale['it']}**.`,
                tr: `**${metaStep.behaviorDisplayNameByLocale['tr']}** davranışını ekleyelim.`,
                ja: `**${metaStep.behaviorDisplayNameByLocale['ja']}** の動作を追加しましょう。`,
                ko: `**${metaStep.behaviorDisplayNameByLocale['ko']}** 동작을 추가해 봅시다.`,
                pl: `Dodajmy zachowanie **${metaStep.behaviorDisplayNameByLocale['pl']}**.`,
                pt: `Vamos adicionar o comportamento **${metaStep.behaviorDisplayNameByLocale['pt']}**.`,
                ru: `Добавим **поведение ${metaStep.behaviorDisplayNameByLocale['ru']}**.`,
                sl: `Dodajmo **vedenje ${metaStep.behaviorDisplayNameByLocale['sl']}**.`,
                sq: `Hajde te shtojme **${metaStep.behaviorDisplayNameByLocale['sq']}** verpim.`,
                th: `เพิ่ม **${metaStep.behaviorDisplayNameByLocale['th']}** พฤติกรรม`,
                uk: `Додайте **поведінку ${metaStep.behaviorDisplayNameByLocale['uk']}**.`,
                zh: `添加 **${metaStep.behaviorDisplayNameByLocale['zh']}** 动作。`,
              },
            },
          },
          isOnClosableDialog: true,
        },
        {
          ...
          tooltip: {
            description: {
              messageByLocale: {
                en: `Select the ${metaStep.behaviorDisplayNameByLocale['en']} behavior.`,
                fr: `Sélectionnez le comportement ${metaStep.behaviorDisplayNameByLocale['fr']}.`,
                ar: `تحديد السلوك ${metaStep.behaviorDisplayNameByLocale['ar']}.`,
                de: `Wählen Sie das ${metaStep.behaviorDisplayNameByLocale['de']}-Verhalten aus.`,
                es: `Selecciona el comportamiento ${metaStep.behaviorDisplayNameByLocale['es']}.`,
                fi: `Valitse ${metaStep.behaviorDisplayNameByLocale['fi']} käyttäytyminen.`,
                it: `Seleziona il comportamento ${metaStep.behaviorDisplayNameByLocale['it']}.`,
                tr: `${metaStep.behaviorDisplayNameByLocale['tr']} davranışını seçin.`,
                ja: `${metaStep.behaviorDisplayNameByLocale['ja']} の動作を選択します。`,
                ko: `${metaStep.behaviorDisplayNameByLocale['ko']} 동작을 선택하세요.`,
                pl: `Wybierz zachowanie ${metaStep.behaviorDisplayNameByLocale['pl']}.`,
                pt: `Selecione o comportamento ${metaStep.behaviorDisplayNameByLocale['pt']}.`,
                ru: `Выберите поведение ${metaStep.behaviorDisplayNameByLocale['ru']}.`,
                sl: `Izberite vedenje ${metaStep.behaviorDisplayNameByLocale['sl']}.`,
                sq: `Selekto ${metaStep.behaviorDisplayNameByLocale['sq']} veprim.`,
                th: `เลือกพฤติกรรม ${metaStep.behaviorDisplayNameByLocale['th']}`,
                uk: `Виберіть поведінку ${metaStep.behaviorDisplayNameByLocale['uk']}.`,
                zh: `选择 ${metaStep.behaviorDisplayNameByLocale['zh']} 动作。`,
              },
            },
          },
          isOnClosableDialog: true,
